...
<div class="wrapper container-fluid px-3">
        ...
        <div class="header-box mt-3">
            <div class="header-content d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
                ...
                <nav class="nav-bar d-flex flex-column flex-sm-row align-items-center gap-3">
                    ...
                    <a href="{{ url('/') }}" class="hover-grow active fw-bold">Panel</a>
                    <a href="{{ route('rides') }}" class="hover-grow">Rides</a>
                    <a href="{{ url('/vehicles') }}" class="hover-grow">Vehículos</a>
                    <a href="{{ route('mybookings') }}" class="hover-grow">Reservas</a>
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    @auth
                        <a href="{{ url('/profile') }}" class="btn btn-sm btn-outline-secondary hover-grow">Perfil</a>
                        <a href="{{ url('/logout') }}" class="btn btn-sm btn-outline-secondary hover-grow">Cerrar sesión</a>
                    @endauth

                    @guest
                        <a href="{{ route('login') }}" class="btn btn-sm btn-outline-secondary hover-grow">Sign In</a>
                    @endguest
    ...
    <footer class="footer text-center mt-4">
        <nav class="footer-nav mb-2">
            <a href="{{ url('/') }}" class="fw-bold hover-grow">Panel</a> |
            <a href="{{ route('rides') }}" class="fw-bold hover-grow">Rides</a> |
            <a href="{{ url('/vehicles') }}" class="fw-bold hover-grow">Vehículos</a> |
            <a href="{{ route('mybookings') }}" class="fw-bold hover-grow">Reservas</a> |
            <a href="{{ route('login') }}" class="fw-bold hover-grow">Login</a> |
            <a href="{{ url('/registration_driver') }}" class="fw-bold hover-grow">Registro Conductor</a> |
            <a href="{{ url('/registration_passenger') }}" class="fw-bold hover-grow">Registro Pasajero</a>
        </nav>
